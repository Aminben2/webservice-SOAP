...
import com.nttdata.webservicesoap.model.Person;
import com.nttdata.webservicesoap.webservice.PersonService;
...
public class SOAPPublisherClient {
  public static void main(String[] args) throws MalformedURLException {
    ...
    QName qname = new QName("http://webservice.webservicesoap.nttdata.com/", "PersonServiceImplService");
    Service service = Service.create(wsdlURL, qname);
    PersonService ps = service.getPort(PersonService.class);
    Person p1 = new Person(); p1.setName("Ali"); p1.setId(1); p1.setAge(30);
    Person p2 = new Person(); p2.setName("Ahmed"); p2.setId(2);
    p2.setAge(25);
